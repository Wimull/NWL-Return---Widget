...
interface FeedbackSuccessStepType{
    resetFeedback: () => void,
}

export function FeedbackSuccessStep({resetFeedback}:FeedbackSuccessStepType ){
    return (
        <>
        <header>
            <ClosingButton />
        ...
        <button
            className="py-2 px-6 mt-6 bg-surface-secondary rounded-[4px] border-transparent text-sm leading-6 hover:bg-surface-secondary-hover transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-surface-primary focus:ring-brand-500"
